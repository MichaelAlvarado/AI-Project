...
public class RandomSearchTest {
	...
	@Test
	public void test1() {
		Node<String> e = RandomSearch.randomSearch(graph.getNode("NY"), graph.getNode("California"));
	...
	@Test
	public void test2() {
		Node<String> e = RandomSearch.randomSearch(graph.getNode("NJ"), graph.getNode("Washington"));
		LinkedList<Node> result = GraphTraversal.reconstructPath(e);
		LinkedList<String> expected = new LinkedList<String>();
		expected.add("NJ");
		expected.add("NY");
	...
	@Test
	public void test3() {
		Node<String> e = RandomSearch.randomSearch(graph.getNode("Ohio"), graph.getNode("NY"));
		LinkedList<Node> result = GraphTraversal.reconstructPath(e);
		LinkedList<String> expected = new LinkedList<String>();
		expected.add("Ohio");
		expected.add("Florida");
	...
	@Test
	public void test4() {
		Node<String> e = RandomSearch.randomSearch(graph.getNode("Florida"), graph.getNode("Ohio"));
		LinkedList<Node> result = GraphTraversal.reconstructPath(e);
		LinkedList<String> expected = new LinkedList<String>();
		expected.add("Florida");
		expected.add("Ohio");
